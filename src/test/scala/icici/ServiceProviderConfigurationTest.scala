...
import icici.reader.mycomponent.MyStreamReaderImpl
import icici.transformer.mycomponent.MyStreamTransformerImpl
import icici.writer.mycomponent.MyStreamWriterImpl
